...
document.getElementById("Ob").innerHTML = "Sketch To Be Drawn : " + Element_of_array;
...
function check_sketch(){
    ...
    if(timer_counter>1000){
        ...
        document.getElementById("Ac").innerHTML = "Confidence: ";
        timer_counter = 0;
...
function updateCanvas(){
    ...
    Element_of_array = quick_draw_data_set[random_number];
    sketch = Element_of_array;
    document.getElementById("Ob").innerHTML = "Sketch To Be Drawn : " + sketch;
}
function setup(){
...
function gotResults(error,results){
    ...
    document.getElementById("Ac").innerHTML = "Confidence: "+Math.round(results[0].confidence * 100)+'%';
}